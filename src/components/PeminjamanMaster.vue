<template>
  <div class="m-5 border border-radius p-5">
    <h1 class="mb-4">Tambah Peminjaman/ Pengembalian</h1>
    <input
        class="form-control"
        type="text"
    ...
    <div class="mt-5">
      ...
      <button type="button" class="btn btn-primary" v-on:click="insertPeminjaman()">Tambah</button>
    </div>
  </div>
</template>
    ...
    insertPeminjaman() {
      ...
      axios
          ...
          .then((resp) => {
            ...
            this.$router.push('/peminjaman-view');

<template>
  <div>
    ...
    <div class="card-container">
      <div class="card" v-for="(data, index) in anggota" :key="data.id">

        <p class="title">{{ data.nama }}</p>
        <div class="card-hidden">
          <p class="title-in">Nama: {{ data.nama }}</p>
          <p>{{ data.jenis_kelamin }}</p>
          <p>No. Telepon: {{ data.no_hp }}</p>
          <p>Alamat: {{ data.alamat }}</p>
          <p>Tanggal Terdaftar: {{ data.tanggal_terdaftar }}</p>
          <div class="card-body">
...
export default {
  ...
  methods: {
    getAnggotaList() {
      axios
          .get('https://mhdrmaulana.my.id/perpustakaan/select_anggota.php')
          .then(response => {
    ...
    hapusAnggota(id) {
      axios
          .delete(`https://mhdrmaulana.my.id/perpustakaan/delete_anggota.php?id=${id}`)
          .then(response => {
